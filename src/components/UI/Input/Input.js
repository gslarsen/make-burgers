...
const Input = (props) => {
  ...
  if (props.invalid && props.touched ) {
    ...
    if (props.elementConfig.name !== 'postal' && props.elementConfig.name !== 'delivery' && props.elementConfig.type !== 'email' && props.elementConfig.type !== 'password') validationError = <p className={classes.ValidationError}>Please enter a valid {props.elementConfig.placeholder}</p>
  }
